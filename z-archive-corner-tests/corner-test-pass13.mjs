// Corner Test Pass 13: R21 Acceptance -- Canonical Project-Chat URL + In-Chat Task Button
//
...
async function run() {
  ...
  try {
    ...
    await page.screenshot({ path: `${DIR}/p13-00-dashboard.png` })
    ...
    await page.screenshot({ path: `${DIR}/p13-01-project-chat.png` })
    ...
    if (!inputEl || !btnEl) {
      ...
      if (projectClicked) {
        ...
        await page.screenshot({ path: `${DIR}/p13-02-project-via-nav.png` })
      }
    }
    ...
    await page.screenshot({ path: `${DIR}/p13-03-input-filled.png` })
    ...
    await page.screenshot({ path: `${DIR}/p13-04-after-create.png` })
    ...
    await page.screenshot({ path: `${DIR}/p13-05-final.png` })

  } catch (err) {
    log('RUNTIME', 'FAIL', err.message.slice(0, 200))
    await page.screenshot({ path: `${DIR}/p13-error.png` }).catch(() => {})
  }
  ...
  const outPath = `${DIR}/pass13-results.json`
