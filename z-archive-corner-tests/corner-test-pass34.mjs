// Corner Test Pass 34: R21 Acceptance -- Canonical Project-Chat URL + In-Chat Task Button
//
...
async function run() {
  ...
  try {
    ...
    await page.screenshot({ path: `${DIR}/p34-00-dashboard.png` })
    ...
    await page.screenshot({ path: `${DIR}/p34-01-project-chat.png` })
    ...
    if (!inputEl || !btnEl) {
      ...
      if (projectClicked) {
        ...
        await page.screenshot({ path: `${DIR}/p34-02-project-via-nav.png` })
      }
    }
    ...
    await page.screenshot({ path: `${DIR}/p34-03-input-filled.png` })
    ...
    await page.screenshot({ path: `${DIR}/p34-04-after-create.png` })
    ...
    await page.screenshot({ path: `${DIR}/p34-05-final.png` })

  } catch (err) {
    log('RUNTIME', 'FAIL', err.message.slice(0, 200))
    await page.screenshot({ path: `${DIR}/p34-error.png` }).catch(() => {})
  }
  ...
  const outPath = `${DIR}/pass34-results.json`
