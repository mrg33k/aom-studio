(() => {
  ...
  // src/dashboard/cv5/CommandDeckHome.jsx
  ...
  function pickGreeting(date = /* @__PURE__ */ new Date()) {
  ...
  var HUES = ["teal", "amber", "violet"];
  function CommandDeckHome({
    user,
    worldId,
    agents = [],
    projectRooms = [],
    ...
    const greeting = (0, import_react.useMemo)(() => pickGreeting(), []);
    ...
    const crew = (0, import_react.useMemo)(() => {
      const arr = [...agents || []];
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { "data-cv5-deck": true, children: [
      ...
      ` }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-space", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "d-torus" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "d-scan" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-deck", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-hud", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-wm", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "d-mk" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Corner" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "d-tele coords", children: [
              "/ deck \xA0\xB7\xA0 ",
              ...
              crew.length,
              " ",
              crew.length === 1 ? "agent" : "agents"
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-tele coords", children: [
            greeting,
            ", ",
            name
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-grid", children: [
          topNeed ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-panel d-hero", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-brk tl" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-brk br" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "l", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-lbl alert", children: [
                "\u25B2 Needs you",
                moreNeeds ? ` \xB7 +${moreNeeds} more` : ""
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: topNeed.label }),
              topNeed.detail && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: topNeed.detail }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-steps", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "s done", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dot" }),
                  "Flagged"
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bar" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "s now", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dot" }),
                  "Your move"
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bar" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "s", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dot" }),
                  "Done"
                ] })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "d-cta", onClick: () => topNeed.onOpen && topNeed.onOpen(), children: "REVIEW NOW \u2192" })
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-panel d-hero calm", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-brk tl" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-brk br" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "l", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "d-lbl", children: "\u25B2 Command deck" }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
                ...
                rooms.length,
                " ",
                rooms.length === 1 ? "room is" : "rooms are",
                " on the deck below."
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "calmdot" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-panel d-rooms", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-brk tl" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hd", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-lbl", children: "Your rooms" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-lbl", children: "activity" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-roomlist", children: [
              visibleRooms.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: "8px 2px", color: "var(--d-faint)", fontFamily: "var(--d-mono)", fontSize: 11 }, children: "No rooms yet. Use the command bar to start one." }),
              visibleRooms.map((p, i) => {
                const hue = HUES[i % HUES.length];
                const ts = p?.last_message_at ? relativeTime(p.last_message_at) : "";
                return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "d-room", onClick: () => onSelectProject && onSelectProject(p, null), children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `hue c-${hue}` }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "body", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nm", children: p.name || p.slug }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "st", children: ts ? `last move ${ts}` : "no activity yet" })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "meta", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-open", children: "open \u2192" }) })
                ] }, p.slug || i);
              })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ft", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "q", children: quietCount > 0 ? `+${quietCount} more ${quietCount === 1 ? "room" : "rooms"}` : "all rooms shown" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "add", onClick: () => onOpenSearch && onOpenSearch(""), children: "+ New room" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-panel d-crewpanel", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-brk br" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-lbl", children: "Crew" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-crewlist", children: [
              crew.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: "8px 2px", color: "var(--d-faint)", fontFamily: "var(--d-mono)", fontSize: 11 }, children: "No agents yet." }),
              crew.map((a, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "d-crewrow", onClick: () => onSelectAgent && onSelectAgent(a), children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ph" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "nm", children: a.name || a.slug }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ds", children: a.is_ea ? "EA" : "agent" })
              ] }, a.slug || i))
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-panel d-cmdbar", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-brk tl" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "d-lbl", children: "Command" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "d-cmd", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
                {
                  ...
                  onKeyDown: (e) => {
                    if (e.key === "Enter" && onOpenSearch) onOpenSearch(cmd);
                  },
                  placeholder: "Command your world  \u2014  @room, /new, or just ask"
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "go", onClick: () => onOpenSearch && onOpenSearch(cmd), children: "\u2191" })
            ] })
          ] })
        ] })
      ] })
  ...
  var ago = (min) => new Date(Date.now() - min * 6e4).toISOString();
  var props = {
  ...
  (0, import_client.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CommandDeckHome, { ...props }));
})();
