...
- **REMAINING: R12 prod promote (Patrik) → R14 punch-list closeout → R15 final acceptance.** Blocker to watch: connector churn stalls Muse builds; disabling unused connectors would free it.
- **NEXT: hand Patrik the prod promote; then R14 punch-list closeout.**
