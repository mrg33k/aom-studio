...
- R55/R56 (10:05-10:35 AM): desktop documents render for real, in a Dracula editor look with an Alucard light toggle (Patrik's pick); production deployed. Phone: documents go through QuickLook (md = plain text) — the native round should match this look.
