...
window.CURRICULUM.friday = {
  ...
  blocks: [
    // ===== INTERLEAVED ORDER (Patrik 2026-05-29 #6) =====
    // welcome → 4 kickoff videos (writing/coding/spelling/MPC in that order)
    //         → round-robin 30 rotations of (w, c, s, m)
    //         → report card
    // Total: 1 + 4 + 120 + 1 = 126 blocks.
    // The per-subject 30-module narratives still flow correctly because
    // their internal order is preserved within each subject's slice.
