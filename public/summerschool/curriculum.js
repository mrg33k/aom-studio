...
window.CURRICULUM = {
  ...
  monday: {
    ...
    blocks: [
      { id: 'welcome',     kind: 'drill', type: 'welcome',      title: 'Welcome',                 minutes: 1  },
      { id: 'reading-1',   kind: 'topic', type: 'reading',      title: 'Reading — chunk 1',       minutes: 10, slice: [0, 2] },
      { id: 'typing-1',    kind: 'drill', type: 'typing',       title: 'Typing Sprint',           minutes: 4  },
      ...
      { id: 'speedread-1', kind: 'drill', type: 'speedread',    title: 'Speed-Read',              minutes: 5  },
      { id: 'tiles-1',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 1',    minutes: 6, words: ['robux', 'studio'] },
      { id: 'video-1',     kind: 'topic', type: 'video',        title: 'Video — Roblox studio',   minutes: 8  },
      { id: 'arduino',     kind: 'topic', type: 'arduino',      title: 'Arduino — Zeus Car DYK',  minutes: 8  },
      { id: 'reading-2',   kind: 'topic', type: 'reading',      title: 'Reading — chunk 2',       minutes: 10, slice: [2, 3] },
      { id: 'money-2',     kind: 'topic', type: 'money',        title: 'Money Move — split $30',  minutes: 8, part: 'scenario' },
      { id: 'wordrun-1',   kind: 'drill', type: 'wordrun',      title: 'Word Run — level 1',      minutes: 12, word: 'studio' },
      { id: 'spelling-1',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 1',      minutes: 8, words: ['platform','currency','studio','percent','design'] },
      ...
      { id: 'speedread-2', kind: 'drill', type: 'speedread',    title: 'Speed-Read +20 WPM',      minutes: 5  },
      { id: 'inspire-1',   kind: 'topic', type: 'inspire',      title: 'A young creator',         minutes: 4  },
      { id: 'tiles-2',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 2',    minutes: 6, words: ['currency', 'platform'] },
      { id: 'spelling-2',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 2',      minutes: 8, words: ['release','audience','maximize','creator','license'] },
      { id: 'math-1',      kind: 'drill', type: 'math',         title: 'Math Game — quickfire',   minutes: 12 },
      { id: 'arduino-w',   kind: 'topic', type: 'writing-mini', title: 'Arduino — micro write',   minutes: 4  },
      ...
      { id: 'splash',      kind: 'drill', type: 'splash',       title: 'End of day',              minutes: 1  }
    ]
  }
};
