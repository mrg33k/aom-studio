...
window.CURRICULUM = {
  ...
  monday: {
    ...
    // Word Tiles vocab pool — word + clue pairs. Tiles blocks pull from here.
    tileVocab: [
      { word: 'robux',     clue: 'The made-up money used only inside Roblox' },
      { word: 'studio',    clue: 'A small company that makes games' },
      { word: 'currency',  clue: 'Money you can spend' },
      { word: 'platform',  clue: 'The website or app where games live' },
      { word: 'license',   clue: 'Official permission to use something' },
      { word: 'maximize',  clue: 'To make as much as possible' },
      { word: 'accessory', clue: "Something extra you wear or attach (like in a game's character)" },
      { word: 'percent',   clue: 'A number out of one hundred' },
      { word: 'design',    clue: 'To plan how something will look or work' },
      { word: 'release',   clue: 'When a new game comes out for everyone to play' },
      { word: 'audience',  clue: 'The people who play or watch what you made' },
      { word: 'creator',   clue: 'The person who made something' }
    ],

    spelling: ['platform', 'currency', 'studio', 'percent', 'design', 'release', 'audience', 'maximize', 'creator', 'license', 'accessory', 'developer', 'purchase', 'company', 'payment', 'players'],
    ...
    blocks: [
      ...
      { id: 'tiles-1',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 1',     minutes: 6, count: 10 },
      ...
      { id: 'spelling-1',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 1',       minutes: 10, words: ['platform','currency','studio','percent','design','release'] },
      { id: 'video-1',     kind: 'topic', type: 'video',        title: 'Video — Roblox studio',    minutes: 10 },
      { id: 'tiles-2',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 2',     minutes: 6, count: 10 },
      ...
      { id: 'tiles-3',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 3',     minutes: 6, count: 10 },
      ...
      { id: 'spelling-2',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 2',       minutes: 10, words: ['audience','maximize','creator','license','accessory','developer'] },
      ...
      { id: 'tiles-4',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 4',     minutes: 6, count: 10 },
      { id: 'spelling-3',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 3 (currency drill)', minutes: 10, words: ['currency','currency','platform','currency','studio','currency'] },
      ...
      { id: 'spelling-4',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 4',       minutes: 10, words: ['purchase','company','payment','players','design','release'] },
      { id: 'tiles-5',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 5',     minutes: 6, count: 10 },
      ...
      { id: 'spelling-5',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 5 (hard words)', minutes: 10, words: ['currency','accessory','developer','maximize','license','audience'] },
      { id: 'tiles-6',     kind: 'drill', type: 'tiles',        title: 'Word Tiles — round 6',     minutes: 6, count: 10 },
      ...
      { id: 'spelling-6',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 6 (review)', minutes: 10, words: ['currency','platform','design','studio','release','percent'] },
      { id: 'spelling-7',  kind: 'drill', type: 'spelling',     title: 'Spelling — round 7 (final)', minutes: 10, words: ['currency','maximize','accessory','developer','company','purchase'] },
