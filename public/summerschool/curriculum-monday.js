...
window.CURRICULUM.monday = {
  ...
  welcomeContent: {
    ...
    howItWorks: "Same rule as Friday. Every block ends with you typing. Character count + spell-check gates the Continue button. Read your answer, then send it to Mom & Dad. No clicking past — the keyboard is the proof."
  },
  ...
  blocks: [
    ...
    { id: 'mon-r-00-video', kind: 'topic', type: 'video-typed', minutes: 8, subject: 'Reading', tag: 'Reading · Kickoff video',
      ...
      typedQuestions: [
        { q: 'What is summarizing, in your own words? Use the words "short" and "important" somewhere in your answer.', minChars: 140 },
        { q: 'Pick something you read or watched recently (book, video, anything). What would a one-sentence summary of it sound like?', minChars: 160 }
      ],
      cta: 'Done' },
    ...
    { id: 'mon-w-00-video', kind: 'topic', type: 'video-typed', minutes: 8, subject: 'Writing', tag: 'Writing · Kickoff video',
      ...
      typedQuestions: [
        { q: 'What do the 5 letters in SMART stand for? Write each one out.', minChars: 120 },
        { q: 'What\'s the difference between a goal and a wish, the way the video explained it?', minChars: 140 }
      ],
      cta: 'Done' },
    ...
    { id: 'mon-m-00-video', kind: 'topic', type: 'video-typed', minutes: 8, subject: 'Math', tag: 'Math · Kickoff video',
      ...
      typedQuestions: [
        { q: 'What does "percent" mean? Use the word "hundred" somewhere in your answer.', minChars: 120 },
        { q: 'What\'s one method the video showed for finding a percentage of a number? Walk through it.', minChars: 160 }
      ],
      cta: 'Done' },
    ...
    { id: 'mon-mp-00-video', kind: 'topic', type: 'video-typed', minutes: 8, subject: 'MPC ONE', tag: 'MPC · Kickoff video',
      ...
      typedQuestions: [
        { q: 'What is a triplet? How many notes is it, and what makes it different from regular 8th notes?', minChars: 140 },
        { q: 'How does the video say to count triplets out loud? (Hint: "one-trip-let" style.) Write the counting.', minChars: 120 }
      ],
      cta: 'Done' },
    ...
    { id: 'mon-r-01', kind: 'topic', type: 'concept', minutes: 4, subject: 'Reading', tag: 'Reading · 01 of 10',
      ...
      typedCheck: { q: 'In your own words, what does the Re-Tell trick make you do right after you read something?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-w-01', kind: 'topic', type: 'concept', minutes: 4, subject: 'Writing', tag: 'Writing · 01 of 10',
      ...
      typedCheck: { q: 'What\'s the difference between a wish and a goal, in your own words?', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-m-01', kind: 'topic', type: 'concept', minutes: 4, subject: 'Math', tag: 'Math · 01 of 10',
      ...
      typedCheck: { q: 'What does the word "percent" literally mean? Use the word "hundred" in your answer.', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-mp-01', kind: 'topic', type: 'concept', minutes: 4, subject: 'MPC ONE', tag: 'MPC · 01 of 10',
      ...
      typedCheck: { q: 'A triplet plays how many notes in the same time as how many regular notes?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-r-02', kind: 'topic', type: 'concept', minutes: 4, subject: 'Reading', tag: 'Reading · 02 of 10',
      ...
      typedCheck: { q: 'Why does knowing you have to summarize make your brain pay more attention while you read?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-w-02', kind: 'topic', type: 'concept', minutes: 5, subject: 'Writing', tag: 'Writing · 02 of 10',
      ...
      typedCheck: { q: 'List the five letters in SMART and what each one stands for.', minChars: 80 },
      cta: 'Got it' },
    ...
    { id: 'mon-m-02', kind: 'topic', type: 'concept', minutes: 4, subject: 'Math', tag: 'Math · 02 of 10',
      ...
      typedCheck: { q: 'What\'s the trick to find 10% of any number? (Hint: the decimal point.)', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-mp-02', kind: 'topic', type: 'concept', minutes: 4, subject: 'MPC ONE', tag: 'MPC · 02 of 10',
      ...
      typedCheck: { q: 'Describe in your own words how triplets sound different from regular 8th notes.', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-r-04', kind: 'topic', type: 'concept', minutes: 4, subject: 'Reading', tag: 'Reading · 04 of 10',
      ...
      typedCheck: { q: 'What are the three parts of the Who-What-Why formula?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-w-04', kind: 'topic', type: 'concept', minutes: 4, subject: 'Writing', tag: 'Writing · 04 of 10',
      ...
      typedCheck: { q: 'Why is "get better at MPC" not a specific enough goal? What\'s missing?', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-m-04', kind: 'topic', type: 'concept', minutes: 4, subject: 'Math', tag: 'Math · 04 of 10',
      ...
      typedCheck: { q: 'If 10% of a number is 12, what is 5% of that same number? How did you figure it out?', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-mp-04', kind: 'topic', type: 'concept', minutes: 4, subject: 'MPC ONE', tag: 'MPC · 04 of 10',
      ...
      typedCheck: { q: 'How many beats per bar are in 3/4 time? Which beat is the strong one?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-w-05', kind: 'topic', type: 'concept', minutes: 4, subject: 'Writing', tag: 'Writing · 05 of 10',
      ...
      typedCheck: { q: 'What kind of word usually shows up in a measurable goal?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-m-05', kind: 'topic', type: 'concept', minutes: 5, subject: 'Math', tag: 'Math · 05 of 10',
      ...
      typedCheck: { q: 'How would you find 20% of any number using the 10% trick?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-mp-05', kind: 'topic', type: 'concept', minutes: 4, subject: 'MPC ONE', tag: 'MPC · 05 of 10',
      ...
      typedCheck: { q: 'Write out the words you say to count one bar of triplets in 4/4.', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-r-06', kind: 'topic', type: 'concept', minutes: 4, subject: 'Reading', tag: 'Reading · 06 of 10',
      ...
      typedCheck: { q: 'Where in a paragraph is the topic sentence usually found?', minChars: 60 },
      cta: 'Got it' },
    ...
    { id: 'mon-w-07', kind: 'topic', type: 'concept', minutes: 4, subject: 'Writing', tag: 'Writing · 07 of 10',
      ...
      typedCheck: { q: 'What usually causes a goal to die — wrong on Specific, or wrong on Achievable + Relevant?', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-m-07', kind: 'topic', type: 'concept', minutes: 4, subject: 'Math', tag: 'Math · 07 of 10',
      ...
      typedCheck: { q: 'A $40 item is 25% off. How much do you pay? Show how you figured it out.', minChars: 80 },
      cta: 'Got it' },
    ...
    { id: 'mon-mp-07', kind: 'topic', type: 'concept', minutes: 6, subject: 'MPC ONE', tag: 'MPC · 07 of 10',
      ...
      typedCheck: { q: 'How many triplet hits will you do per bar at 4/4? Why that number?', minChars: 70 },
      cta: 'On it' },
    ...
    { id: 'mon-r-08', kind: 'topic', type: 'concept', minutes: 4, subject: 'Reading', tag: 'Reading · 08 of 10',
      ...
      typedCheck: { q: 'Which of the three mistakes is the one you think you\'d most likely make? Why?', minChars: 80 },
      cta: 'Got it' },
    ...
    { id: 'mon-w-08', kind: 'topic', type: 'concept', minutes: 4, subject: 'Writing', tag: 'Writing · 08 of 10',
      ...
      typedCheck: { q: 'Why does a goal need a deadline, even a short one?', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-m-08', kind: 'topic', type: 'concept', minutes: 5, subject: 'Math', tag: 'Math · 08 of 10',
      ...
      typedCheck: { q: 'What are the two steps to find a 20% tip on any bill, using the 10% trick?', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-mp-09', kind: 'topic', type: 'concept', minutes: 4, subject: 'MPC ONE', tag: 'MPC · 09 of 10',
      ...
      typedCheck: { q: 'Pick one song or kind of music you\'ll go listen to today to hear triplets or 3/4 time. Name it.', minChars: 70 },
      cta: 'Got it' },
    ...
    { id: 'mon-r-10', kind: 'topic', type: 'concept', minutes: 3, subject: 'Reading', tag: 'Reading · 10 of 10',
      ...
      typedCheck: { q: 'When you can\'t summarize what you read in one sentence, what does that tell you to do?', minChars: 60 },
      cta: 'Done' },
    ...
    { id: 'mon-w-10', kind: 'topic', type: 'concept', minutes: 3, subject: 'Writing', tag: 'Writing · 10 of 10',
      ...
      typedCheck: { q: 'What\'s the rest of the work after writing a SMART goal?', minChars: 60 },
      cta: 'Done' },
    ...
    { id: 'mon-m-10', kind: 'topic', type: 'concept', minutes: 3, subject: 'Math', tag: 'Math · 10 of 10',
      ...
      typedCheck: { q: 'What\'s your plan for practicing percentages this week in real life?', minChars: 70 },
      cta: 'Done' },
    ...
    { id: 'mon-mp-10', kind: 'topic', type: 'concept', minutes: 3, subject: 'MPC ONE', tag: 'MPC · 10 of 10',
      ...
      typedCheck: { q: 'What\'s your MPC warm-up plan this week, in one sentence?', minChars: 70 },
      cta: 'Done' },
