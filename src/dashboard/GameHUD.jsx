...
// DONE(bobby): "RIGHT NOW" PILL -- Right Now pill LIVE. Pulls running agents from events table (task_started events). Pinned first. Orange/fire color. Pulsing glow. REMAINING: drag-to-right-now (see TODO(bobby) DRAG-TO-RIGHT-NOW below), time estimates per task.
...
// DONE(bobby2): LIVE TASK UPDATES IN HUD (KEY KEY KEY) -- isAutoChecked() reads task_completed events from events table, fuzzy-matches against punch-list task text (2+ keyword overlap), and auto-checks matching items in the UI (optimistic). Priority sort: Right Now > Today > by-importance. Auto-checked items get autoChecked flag for distinct styling. Ref: Patrik feedback line 258-259, 263.
...
export default function GameHUD({
  ...
  return (
    <div
      ...
      style={{
        position: 'fixed',
        // Both snaps: HUD sits flush at bottom. Drawer at half-snap (52% height) sits above it.
        bottom: 0,
        left: 0, right: 0,
        zIndex: 40,
        pointerEvents: 'auto',
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          paddingBottom: isMobile ? 'calc(env(safe-area-inset-bottom, 0px) * 0.4)' : undefined,
          margin: isMobile ? 0 : '0 12px',
