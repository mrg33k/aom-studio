...
class RoomThreadEngine {
  ...
  async send(text, options = {}) {
    ...
    // Which agent this project/mission turn is addressed to. The composer's Agent
    // picker passes the room's chosen agent; unset falls back to the front desk
    // ('corner'), which is the historical behavior. 1:1 rooms ignore this — their
    // agent IS the room.
