...
// Ported verbatim from the CV6 design system (components/navigation/ToolTile.jsx).

/**
 * A tool entry in the navigation set (Home, Chat, Organize, Review, Support,
 * Tracker, Command, Live Scribe). Layouts:
 *  - layout="tile"    → desktop tools row: wide rounded tile, icon over label
 *  - layout="compact" → top-bar nav tile: shrunk icon over a small label
 *  - layout="rail"    → mobile side rail: compact icon square + tiny label below
 * Active swaps to an accent fill; inactive sits on the chip/surface fill.
 */
