    ...
    <div style={{
      ...
      {tab === 'chat' && !selectedAgent && (
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 6px 28px rgba(0,0,0,0.5), 0 2px 8px rgba(0,0,0,0.3)' }}
          onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 24px rgba(0,0,0,0.4), 0 1px 6px rgba(0,0,0,0.3)' }}
        >
          Schedule Service
        </button>
      )}
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ fontSize: 22, fontWeight: 800, color: C.text, letterSpacing: '-0.03em', lineHeight: 1.2 }}>
                Let's talk
              </div>
              <div style={{ fontSize: 13, color: C.text2, marginTop: 8, lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                <div key={label}>
                  <div style={{ fontSize: 12, fontWeight: 600, color: C.text2, marginBottom: 6 }}>{label}</div>
                  <input
                    type={type}
                    ...
                    onBlur={e => { e.currentTarget.style.border = '1px solid ' + C.border2 }}
                  />
                </div>
              ))}
              <div>
                <div style={{ fontSize: 12, fontWeight: 600, color: C.text2, marginBottom: 6 }}>Message</div>
                <textarea
