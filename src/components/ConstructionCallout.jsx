...
const proofPoints = [
  {
    icon: Users,
    stat: 'Recruiting',
    description: 'Your best crews aren\'t on Indeed. They\'re watching Instagram. Show them why your company is the one to work for.',
  },
  {
    icon: Trophy,
    stat: 'Winning Bids',
    description: 'GCs check your online presence before they return your call. Professional content is the difference between shortlist and no-list.',
  },
  {
    icon: Building2,
...
export default function ConstructionCallout() {
  return (
    <section className="py-16 md:py-24 bg-aom-night relative overflow-hidden">
      {/* Subtle warm accent */}
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="mb-12">
          ...
          <h2 className="font-headline text-3xl md:text-5xl lg:text-6xl font-black italic uppercase tracking-tighter text-aom-warm-white max-w-[45ch] leading-[0.9]">
          ...
          >
            ...
            <div className="p-6 md:p-8 rounded-sm border border-aom-orange/40 bg-orange-950/10 shadow-2xl flex-1 flex flex-col">
              ...
              <p className="text-aom-stone text-sm leading-relaxed mb-2">
                Full-service content engine. Website, social media, filming. One HVAC company that decided their brand should match the quality of their work.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div className="p-4 rounded-sm border border-aom-border bg-aom-charcoal">
                  <p className="font-headline text-2xl font-black italic text-aom-orange">1</p>
                  <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-aom-stone-muted mt-1">Filming Day</p>
                </div>
              </div>
