...
function ServiceCard({ service, index, scrollToSection }) {
  ...
  return (
    ...
    >
      ...
      {/* Micro-label */}
      <p className="text-[11px] font-mono font-bold uppercase tracking-[0.3em] text-aom-warm-gray mb-2">
        {service.label}
      </p>
  ...
  return (
    <section className="py-20 md:py-32 bg-aom-cream" aria-label="Services">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        {/* Section header */}
        <div className="mb-12">
          <p className="text-[11px] font-mono font-bold uppercase tracking-[0.3em] text-aom-warm-gray mb-4">
            What We Build
          </p>
