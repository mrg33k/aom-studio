...
export default function SourcingMarketplacePost() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Find or create a placeholder company record
      // In production this would require auth + company verification
      // For now, look up by email
      let companyId = null;
            ...
            <div style={{ background: V.card, border: `1px solid ${V.border}`, borderRadius: 10, padding: '20px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <InputField
                  ...
                  placeholder="Acme Semiconductor Inc."
                />
                <InputField
                  label="Company Email"
                  required
                  ...
                  hint="Used to link listing to your company profile."
                />
              </div>
            </div>
            ...
            <div style={{ background: V.card, border: `1px solid ${V.border}`, borderRadius: 10, padding: '20px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <InputField
                  ...
                  value={form.title}
                  onChange={set('title')}
                  placeholder="Used Lam Research Etch System — 200mm"
                />
                <TextareaField
                  label="Description"
                  value={form.description}
                  onChange={set('description')}
                  placeholder="Include make, model, year, condition details, reason for sale, etc."
                />
                ...
                <InputField
                  ...
                  placeholder="https://..."
                  hint="Link to a hosted photo of the equipment."
                />
                <InputField
                  label="Contact Email"
                  required
                  ...
                  hint="Buyers will contact you at this address."
                />
              </div>
            </div>
