...
const PROJECTS = [
  ...
  },
  {
    name: 'Space Rising',
    slug: 'space-rising',
    desc: 'Complete redesign and go-to-market for new space technology platform',
  ...
  },
  {
    name: 'Brandon Wiley',
    slug: 'brandon-wiley',
    desc: 'Documentary-style narrative for documentary filmmaker and producer',
    poster: null,
    section: 'Case Studies',
  },
  {
    ...
    desc: 'Brand identity and positioning for luxury hospitality collection',
    poster: null,
    section: 'Case Studies',
  },
  {
    name: 'PA\'LA',
    slug: 'pala',
    desc: 'Sustainable fashion brand launch with storytelling integration',
    poster: null,
    section: 'Case Studies',
  },
  {
    name: 'Kohrs',
    slug: 'kohrs',
    desc: 'Architectural visualization and digital experience for design studio',
    poster: null,
    section: 'Case Studies',
  },
  {
    name: 'Intelliplay',
    slug: 'intelliplay',
    desc: 'EdTech platform brand and user experience overhaul',
    poster: null,
    section: 'Case Studies',
  },
  // INDUSTRIES
