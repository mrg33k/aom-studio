  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0C0C0C', color: '#fff', fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <nav style={{
        ...
        <Link to="/sourcing" style={{ textDecoration: 'none', fontSize: 13, color: 'rgba(255,255,255,0.5)', fontFamily: "'Space Grotesk', sans-serif" }}>Sourcing</Link>
        <span style={{ color: 'rgba(255,255,255,0.2)', fontSize: 13 }}>/</span>
        <span style={{ fontSize: 13, color: '#fff', fontFamily: "'Space Grotesk', sans-serif" }}>About</span>
        <div style={{ flex: 1 }} />
        <ThemeToggle />
        <Link to="/sourcing/sc3/signup" style={{
      ...
      <section style={{ padding: 'clamp(48px, 6vw, 72px) 24px', maxWidth: 780, margin: '0 auto', textAlign: 'center' }}>
        ...
        <Link to="/sourcing/sc3/checkout" style={{
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', gap: 20 }}>
          {[
            { label: 'Directory', href: '/sourcing/sc3' },
            { label: 'List Company', href: '/sourcing/sc3/signup' },
            { label: 'Admin', href: '/sourcing/admin' },
          ].map(l => (
