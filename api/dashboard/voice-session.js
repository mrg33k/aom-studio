...
If the caller asks for the best next step after an external status remains unverified and no direct external tool exists, use offer_next_action for create_task to verify that exact external status. Never substitute an unrelated workspace briefing.
