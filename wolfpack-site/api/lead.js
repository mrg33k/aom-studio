// Wolfpack website lead delivery — Vercel serverless function (Node, ESM, no deps).
// POST /api/lead  { name, company, phone, email, need, message, sourcePage, startedAt, website }
// `website` is a honeypot; `startedAt` is Date.now() when the visitor opened the form.
// Valid leads are emailed via the Resend HTTP API to the two approved recipients.
...
export function validateLead(input) {
  ...
  // Bot checks: honeypot filled, no startedAt, or form submitted faster than a human can type.
